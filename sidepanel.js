...
const PROMPT_INSTRUCTIONS = Object.freeze({
  ...
  "debug-progress": [
    ...
    "먼저 코드와 주석에서 사용자의 현재 접근, 발견한 패턴, 확인하려는 질문을 판단 없이 요약해 주세요.",
    "주석에 명시된 질문에는 먼저 직접 답해 주세요. 가설과 패턴은 문제 조건, 예제, 실행 결과, 현재 코드에서 확인할 수 있는 근거로 하나씩 검토하고, 각각 '확인됨', '가능성 있음', '근거 부족', '반례 있음' 중 하나로 구분해 주세요.",
    "가설이 일부만 맞거나 틀렸다면 결론부터 단정하지 말고, 어디까지 성립하고 어느 조건에서 깨지는지 가장 작은 반례나 추적할 값과 함께 설명해 주세요.",
    "확인된 사실과 추측을 분리하고, 정보가 부족하면 부족하다고 명시해 주세요. 사용자가 요청하지 않은 전체 정답 코드나 전면 재작성은 제공하지 마세요.",
    "마지막에는 지금 코드에서 이어서 해 볼 수 있는 가장 작은 디버깅 단계 1~3개만 우선순위대로 제안해 주세요."
  ],
  solution: [
